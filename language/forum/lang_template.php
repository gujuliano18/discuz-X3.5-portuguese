...
$lang = array (
  ...
  'edit' => 'Editar',//编辑
  'lastpost' => 'Última publicação',//最后发表
  'replies' => 'Respostas',//回复/查看
  'reward_solved' => '已解决',
  'unresolved' => '未解决',
  'thread_activity' => '活动',
  'thread_debate' => '辩论',
  ...
  'comment_message1' => 'Você pode inserir até',//还可输入
  'comment_message2' => 'caractéres',//个字符
  'comments' => '点评',
  'more' => 'Mais',//更多
  'publish' => '发布',
  'detail' => 'Detalhes',//详情
  ...
  'forum_lastpost' => '最后发表',
  'forum_moderators' => 'Moderador',//版主
  'forum_myfav' => '我收藏的版块',
  'forum_posts' => 'Publicações',//帖数
  'forum_subforums' => '子版块',
  'forum_threads' => '主题',
  'forum_todayposts' => 'Publicações Hoje',//今日
  'hotthreads_forum' => '$_G[\'setting\'][\'navs\'][2][\'navname\']热点',
  'index_guests' => 'Visitantes',//位游客
  'index_invisibles' => 'Invisíveis',//隐身
  'index_members' => 'Membros ',//会员
  'index_mostonlines' => 'Recorde Online ',//最高记录是
  'index_posts' => 'Publicações',//帖子
  'index_today' => 'Hoje',//今日
  'index_yesterday' => 'Ontem',//昨日
  'my_posts' => 'Minhas Publicações',//我的帖子
  'never' => 'Nenhuma',//从未
  'on' => 'em',//于
  'online_only_guests' => 'Apenas convidados ou membros invisíveis estão online no momento',//当前只有游客或隐身会员在线
  'onlinemember' => 'Amigos',//在线会员
  'onlines' => 'Onlines',//人在线
  'private_forum' => 'Seção privada',//私密版块
  'show_newthreads' => 'Última resposta',//最新回复
  'spread' => '收起/展开',
  'total' => 'Total',//总计
  'url_link' => 'Link para endereço externo',//链接到外部地址
  'welcome_new_members' => 'Bem vindo novo membro',//欢迎新会员
  'attachcredits' => '下载积分',
  'attachment_buy' => '购买',
  ...
  'forum_recyclebin' => 'Lixeira',//回收站
  'forum_viewall' => '全部',
  'index_threads' => '主题',
  'forum_live_newreply_refresh' => 'Há novos comentários, clique em atualizar',//有新的发言了，点击刷新
  'forum_live_fastreply_notice' => '#resposta rápida aqui#',//#在这里快速回复#
  'forum_live_post' => 'Publicar',//发表
  'forum_live_nocontent_error' => 'Desculpe, você ainda não digitou nada',//抱歉，您尚未输入内容
  'forum_live_nolength_error' => '\'Sua publicação não atende aos requisitos. \n\nComprimento atual: \' + mb_strlen(theform.message.value) + \' byte\nLimitações do sistema: \' + postminchars + \' 到 \' + postmaxchars + \' byte\'',//\'您的帖子长度不符合要求。\n\n当前长度: \' + mb_strlen(theform.message.value) + \' 字节\n系统限制: \' + postminchars + \' 到 \' + postmaxchars + \' 字节\'
  'modcp' => 'AdminCP',//管理面板
  'post_newthread' => 'Publicar',//发表帖子
  'post_newthreadactivity' => '发起活动',
  'post_newthreaddebate' => '发起辩论',
  'post_newthreadpoll' => 'Votação',//发起投票
  'post_newthreadreward' => '发布悬赏',
  'post_newthreadtrade' => '出售商品',
  'recommended_groups' => '推荐{$_G[\'setting\'][\'navs\'][3][\'navname\']}',
  'return_index' => '返&nbsp;回',
  'rss_subscribe_this' => 'Inscrever',//订阅
  'send_posts' => 'Nova',//发新帖
  'their' => '所属分类',
  'threads_all' => 'Todos os tópicos',//全部主题
  ...
  'login_to_post' => 'Você precisa fazer login antes de publicar',//您需要登录后才可以发帖
  ...
  'post_advancemode' => 'Modo Avançado',//高级模式
  'post_relay' => '转播给听众',
  'post_sync_method' => '将此主题同步到',
  'quick_post' => 'Publicar rapidamente',//快速发帖
  ...
  'closed_thread' => '关闭的主题',
  'digest_posts' => '精华',
  'forum_group' => 'Seção/Grupo',//版块/圈子
  'forum_nothreads' => 'Não há tópicos nesta seção ou no intervalo especificado',//本版块或指定的范围内尚无主题
  'forum_thread' => '版块主题',
  'from' => '来自',
  'fromgroup' => '来自圈子',
  'selectmygroup' => '选择我的圈子',
  'have_newreplies' => 'Há novas respostas ao tópico',//有新回复 的主题
  'heats' => '热度',
  'heats_icon' => '火',
  'last_1_days' => '一天',
  'last_2_days' => '两天',
  ...
  'new_window' => 'Nova janela',//新窗
  'new_window_thread' => 'Abrir publicação em uma nova janela',//在新窗口中打开帖子
  'order_heats' => '热门',
  'order_recommends' => '推荐',
  'orderby' => '排序',
  'pics' => '张图片',
  ...
  'avatar_del' => '删除头像',
  'bio' => '自我介绍',
  'changeto' => 'Mudar para',//变更为
  'crime_action' => '操作行为',//操作行为
  'crime_avatar' => '清除头像',//清除头像
  'crime_banpost' => 'Bloquear publicação',//屏蔽帖子
  'crime_banspeak' => 'Proibido de falar',//禁止发言
  'crime_banstatus' => 'Bloquear usuário',//锁定用户
  'crime_banvisit' => 'Acesso proibido',//禁止访问
  'crime_customstatus' => '清除自定义头衔',//清除自定义头衔
  'crime_dateline' => '操作时间',//操作时间
  'crime_delpost' => 'Excluir publicação',//删除帖子
  'crime_operator' => '操作者',//操作者
  'crime_reason' => 'Motivo',//操作理由
  'crime_record' => 'Registro de violação',//违规记录
  'crime_sightml' => '清除签名',//清除签名
  'crime_warnpost' => '警告帖子',//警告帖子
  'expiry' => '期限',//期限
  'ip_location' => '地理位置',
  'mod_member_ban' => '禁止用户',
  ...
  'edit_trade' => '编辑商品',
  'faq' => 'FAQ',//帮助
  'join_thread' => 'Participe/responda ao tópico',//参与/回复主题
  'post_credits_rule' => 'Regras de pontuação para esta edição',//本版积分规则
  ...
  'poll_close' => '关闭投票',
  'poll_finish' => '已结束',
  'post_poll_add' => ' Adicionar mais 1 item',//增加一项
  'post_poll_allowmultiple' => 'Multiplas',//最多可选
  'post_poll_comment' => 'Pode preencher no máximo {$_G[\'setting\'][\'maxpolloptions\']} opções',//最多可填写 {$_G[\'setting\'][\'maxpolloptions\']} 个选项
  'post_poll_comment_s' => 'Preencha 1 opção por linha',//每行填写 1 个选项
  'post_poll_expiration' => 'Contar dias',//记票天数
  'post_poll_options' => 'Obs',//选项 (Opções) toma muito espaço, texto quebra linha na janela fica feio
  'post_poll_overt' => '公开投票参与人',
  'post_poll_exceed' => '已达到最大投票数',
  'post_single_frame_mode' => 'Modo Simples',//单框模式
  ...
  'admin_live' => 'Transmissão ao vivo',//直播
  'admin_live_cancle' => 'Cancelar transmissão ao vivo',//取消直播
  'admin_live_tips' => 'Apenas uma transmissão ao vivo pode ser definida na mesma seção<br>Depois de configurar a transmissão ao vivo, a publicação original da transmissão ao vivo será substituída<br>Recomenda-se defini-la após mais de 5 respostas.同一版块内只能设置一个直播帖<br>设置直播后会覆盖原有直播帖<br>建议超过5条回复后设置',//同一版块内只能设置一个直播帖<br>设置直播后会覆盖原有直播帖<br>建议超过5条回复后设置
  'pay_buyers' => '已购买人数',
  ...
  'poll_hour' => '小时',
  'poll_minute' => '分钟',
  'poll_more_than' => 'Até $maxchoices itens podem ser selecionados',//最多可选 $maxchoices 项
  ...
  'main_nav' => '主导航',//主导航
  'quick_nav' => 'Navegação',//快捷导航
  'post_deleted' => '无效楼层，该帖已经被删除',
  'have_posted' => '已发表',
  'guide_draft' => '草稿',
  'pending' => 'Revisão pendente',//待审核
  'preview' => '预览',
  'expire_dateline' => 'Validade',//过期时间
  'darkroom' => 'Punidos',//小黑屋
  'darkroom_no_users' => 'Ninguém foi punido ainda, todos são membros modelo ~',//还没有人入住小黑屋，大家都是模范会员~
  'replystick' => '置顶回复',
  'replystick_icon' => '顶',
  'search_forum' => 'Pesquisar',//搜索版块
  'latest_images' => '最新图片',
  'hot_thread' => '热门帖子',
  'my_order_collection' => '我订阅的专辑',
  'recommend_collection' => '淘专辑推荐',
  'rank' => 'Classificação',//排名
  'previous_rank' => 'Última classificação',//上次排名
  'latest' => 'Recente',//最新
