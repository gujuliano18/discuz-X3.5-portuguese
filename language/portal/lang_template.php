...
$lang = array (
  ...
  'no_content' => 'Desculpe, não há mais conteúdo para este módulo',//抱歉，此模块没有更多内容
  ...
  'submit' => 'Enviar',//提交
  'view_article' => '查看文章',
  'block_adddata' => 'Adicionar',//添加
  'block_adddata_comment' => 'Adicionar dados',//添加数据
  'block_cancel_favorite' => 'Remover dos favoritos',//取消收藏
  'block_data' => 'Dados do Módulo',//模块数据
  ...
  'block_favorite' => 'Adicionar aos favoritos',//收藏
  'block_id' => 'Módulo ID',//模块标识
  'block_isblank' => '只接受推送数据',
  'block_isblank_tips' => '勾选此项，则该模块只显示推送的数据，不自动聚合数据',
  'block_item_display_num' => '显示条数',
  'block_itemdata' => 'Biblioteca Push',//推送库
  'block_management' => 'Módulos',//模块管理
  'block_moreurl' => '更多页设置',
  'block_properties' => 'Propriedades do Módulo',//模块属性
  'block_properties_comment' => '此模块数据由属性决定，请编辑属性以展示需要的数据',
  'block_start_time' => '开始时间',
  'block_start_time_comment' => '留空表示立即开始',
  'block_stop' => '屏蔽',
  'block_template' => '模块模板',
  'block_type' => 'Tipo do Módulo --->',//模块分类
  ...
  'never_update' => '永不更新',
  'no' => '否',
  'no_data' => 'Nenhum dado relevante',//没有相关数据
  'no_data_mod' => 'Ainda não há dados na biblioteca push deste módulo',//此模块的推送库里还没有任何数据
  'not_auto_update' => '不自动更新',
  'not_stick' => '不置顶',
  'operation' => 'Operação',//操作
  ...
  'background' => '背景',
  'background_attach_fixed' => 'Fixo',//固定
  ...
  'admin_pm' => '通知作者',
  'all_page' => 'Todas as páginas',//全部页面
  'block_in_updateline' => 'Entrou na fila de atualização',//已进入更新队列
  'block_list' => ' Lista de módulos',//模块列表
  'block_no_managable' => 'Nenhum módulo foi encontrado com este ID',//没有可管理的模块
  'block_not_in_updateline' => ' 秒后进入更新队列',
  'block_operation' => 'Operação',//操作
  'block_page' => 'Página atual',//所在页面
  'block_verifieddata' => 'Dados verificados',//已审核数据
  'block_verifydata' => 'Dados não verificados',//未审核数据
  'click_return_list' => 'Clique para retornar à lista',//点击返回列表页
  'data' => 'Dados',//数据
  'find' => 'Encontrar',//查找
  'mod_category' => 'Categoria',//模块分类
  'property' => 'Propriedade',//属性
  'push' => '推送',
  'push_dateline' => '推送时间',
  'push_people' => '推送者',
  'push_updateblock' => 'Colocar na fila',//加入更新队列
  'push_updateblock_tips' => 'Os módulos adicionados à fila de atualização não serão atualizados imediatamente. <br>A atualização só será ativada quando a página onde o módulo está localizado for acessada.',//已经加入更新队列的模块并不立即更新，当此模块所在的页面被访问时才触发更新，请耐心等待
  'show_push' => '显示推送标志',
  'unoperation' => '&minus;',
  'unused' => '未使用',
  'update_block_tips' => '数据通过审核以后，相应的模块将加入更新队列',
  'view_select_mod' => 'Somente os módulos sob os critérios de pesquisa são exibidos. ',//仅显示搜索条件下的模块。
  'add_by_self' => '手工添加',
