...
$lang = array (
  ...
  'follow_select_forum' => 'Selecione a seção',//选择版块
  ...
  'want_to_register' => 'Quero me registrar',//我要注册
  'welcome' => 'Bem vindo，',//欢迎您，
  'add' => 'Adicionar',//添加
  ...
  'eccredit_soso' => '中评',
  'eccredit_total' => '总计',
  'have_posted' => 'Publicado',//已发表
  'payto_creditinfo' => '支付宝账户信用信息',
  'recyclebin' => 'Lixeira',//回收站
  'taobao' => '阿里旺旺',
  'del_favorite' => '删除选中收藏',
  ...
  'favorite_article' => '文章',
  'favorite_blog' => '日志',
  'favorite_forum' => 'Fórum',//版块
  'favorite_group' => '{$_G[\'setting\'][\'navs\'][3][\'navname\']}',
  'favorite_thread' => '帖子',
  'no_favorite_yet' => '您还没有添加任何收藏',
  'select_all' => 'Selecionar tudo',//全选
  'click_play' => '点击播放',
  'click_view' => 'clique para visualizar',//点击查看
  'delete_feed' => '删除动态',
  ...
  'friend_post' => '好友的帖子',
  'group' => 'Grupo',//圈子',
  'hide_thread' => 'Esta página tem $hiddennum publicações ocultas devido a questões de privacidade',//本页有 $hiddennum 篇帖子因隐私问题而隐藏
  'ignored' => 'Ignorado',//已忽略
  'last_post' => 'Última Publicação',//最后发帖
  'my_post' => 'Minhas Publicações',//我的帖子
  'newest_thread' => 'Publicações Recentes',//最新帖子
  'no_related_posts' => 'Ainda não há publicações relacionadas',//还没有相关的帖子
  'post_comment' => 'Comentário Publicado',//点评
  'posted' => 'Publicado',//发帖
  ...
  'about_space' => '家园相关',
  'bytes' => '字节',
  'forum_name' => 'Nome da seção',//版块名称
  'free' => '免费',
  'free_buy' => '免费购买',
  'main_usergroup' => '主用户组',
  'memcp_usergroup_unallow' => 'Sinto muito! Este site ainda não abriu um grupo de usuários disponível para compra.',//本站尚未开通可供购买的用户组
  ...
  'usergroup_right_message1' => 'Indica permitido',//表示有权操作
  'usergroup_right_message2' => 'Indica não permitido',//表示无权操作
  'usergroup_right_message3' => 'Indica que você deve ter a permissão específica',//表示必须拥有指定的认证
  'youhave' => 'Você tem:->',//您目前有
  'yourusergroup' => 'Grupo de usuários atual',//当前用户组
  'my' => 'Minhas Permissões do ',//我的
  'my_usergroups' => 'Meu Grupo de Usuários',//我的用户组
  'rights' => '',//权限 (Vazio) devido um problema de direção do texto e sentido da tradução (texto total ficou na linha 1526 (Minhas Permissões do ) com espaço no final para encaixar com restante que fica em outra linha.
  'usergroups_joinbuy' => 'Comprar Grupo de Usuários',//购买用户组
