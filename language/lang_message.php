...
$lang = array (
  ...
  'group_module_status_off'  => 'Desculpe, a função grupo ainda não está habilitada',//抱歉，圈子功能尚未开启
  ...
  'not_loggedin' => 'Desculpe, você não está logado e não pode realizar esta operação',//抱歉，您尚未登录，无法进行此操作
  ...
  'register_activation_message' => 'Desculpe, o nome de usuário "{username}" que você digitou já existe. Faça login para ativar esta conta.',//抱歉，您输入的用户名 "{username}" 已存在，请登录站点激活此账号
  'profile_password_tooshort' => 'A senha é muito curta, pelo menos {pwlength} caractéres',//密码太短了，至少要{pwlength}个字符
  'profile_required_info_invalid' => 'Desculpe, você não preencheu os campos obrigatórios ou o formato dos campos obrigatórios está incorreto.',//抱歉，您尚未填写必填项目或必填项目格式不正确
